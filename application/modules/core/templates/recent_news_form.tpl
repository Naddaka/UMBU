                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select name="display" id="comcount">
                                        ...
                                        <!-- naddaka-mode: в виджете последних публикаций добавить возможность выводить статьи случайным способом -->
                                    <option value="random" {if $widget.settings.display == 'random'} selected="selected" {/if}>{lang("Random", 'core')}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="control-group">
